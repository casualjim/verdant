...
pub trait SupportedLanguage<'set, S>: Sized {
    ...
    /// [official parser collections](https://casualjim.github.io/syntastica/cj-syntastica/#parser-collections)
...
/// [the project overview](https://casualjim.github.io/syntastica/cj-syntastica/#parser-collections)
