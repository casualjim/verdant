;; Forked from https://raw.githubusercontent.com/gmlarumbe/tree-sitter-systemverilog/7c4b01b7df2f6e7fa1f698c9d30ac8f93af18ed2/queries/highlights.scm
;; Comments
...
(class_scope
  ; Definition of extern defined methods
  (class_type
    (simple_identifier)
  ) @function
)
...
; void cast of task called as a function
...
(value_range
  ; inside {[min_range:max_range]}, place here to apply override
  (expression) @constant
)
