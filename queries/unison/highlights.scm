;; Forked from https://github.com/nvim-treesitter/nvim-treesitter/blob/master/queries/unison/highlights.scm
...
(effect
  (regular_identifier) @attribute
)

; NOTE: an effect is a special type
; Namespaces
(path) @module
